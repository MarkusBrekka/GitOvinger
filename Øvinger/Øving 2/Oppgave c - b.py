# -*- coding: utf-8 -*-
"""
Created on Wed Aug 30 11:41:15 2023

@author: marku
"""
# Antall ladinger = tur_lengde 
...
if rekkevidde_km <= 0:
    print("Oida... her trenger du nok mer enn å bare lade batteriet, håper du er NAF-medlem!")

else:
    antall_ladinger = int((tur_lengde_km - (rekkevidde_km * 0.2)) // (rekkevidde_km*0.6))
